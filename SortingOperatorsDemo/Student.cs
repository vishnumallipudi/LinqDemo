...
namespace SortingOperatorsDemo
{
    class Student
    {
        ...
        public static IEnumerable<Student> GetAllStudents()
        {
            ...
            var emps = new List<Student>() {
                ...
                new Student() {Id=5,Firstname="Ram",LastName="Paluri",Email="ram@domain.com",Subjects=new List<string> { "HTML","CSS","Javascript"},Gender="Female" },
